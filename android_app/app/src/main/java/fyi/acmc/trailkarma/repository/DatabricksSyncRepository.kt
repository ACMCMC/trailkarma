        ...
        try {
            ...
            for (row in rows) {
                try {
                    ...
                    // Always update if exists, insert if new (simple hackathon approach)
                    if (localReport != null) {
                    ...
                    Log.d("DatabricksSync", "✓ Synced report: $title")
                    syncedCount++
                } catch (e: Exception) {
            ...
            Log.d("DatabricksSync", "✓ Successfully synced $syncedCount reports from cloud")
            return true
        } catch (e: Exception) {
